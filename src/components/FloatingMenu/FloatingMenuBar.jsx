...
const FloatingMenuBar = ()=>{
    ...
    const [windowDimensions, setWindowDimensions] = useState({
      ...
      const [buttonDivClassName, setButtonDivClassName] = useState("button-div");

      const shortMenuClick = ()=>{
        setIsShortMenuIconClicked((prev) => !prev);

        if (!isShortMenuIconClicked) {
          setButtonDivClassName("button-expand-div")
        } else {
          setButtonDivClassName("button-div")
        }
      }
    ...
    return(
        ...
        (
            <div className={buttonDivClassName}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="27px" viewBox="0 -960 960 960" width="24px" fill="yellow"><path d="M200-160v-366L88-440l-48-64 440-336 160 122v-82h120v174l160 122-48 64-112-86v366H520v-240h-80v240H200Zm80-80h80v-240h240v240h80v-347L480-739 280-587v347Zm120-319h160q0-32-24-52.5T480-632q-32 0-56 20.5T400-559Zm-40 319v-240h240v240-240H360v240Z"/></svg>
                <a className="menu-text text-white text-2xl font-semibold">Home</a>
                </div>
                <div className='hamburgerMenuSvg-div'  onClick={() => shortMenuClick()}>
                <svg fill="white" className="ham-icon" xmlns="http://www.w3.org/2000/svg" height="27px" viewBox="0 -960 960 960" width="24px"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
                </div>
            </div>
        ):
        (
            <div className='long-button-div'>
            <ul className='text-xl leading-6 font-extrabold whitespace-nowrap'>
                <li className='long-menu-li'>
